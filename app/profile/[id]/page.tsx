    ...
    <motion.div className='bg-gradient-to-r from-rose-400 via-fuchsia-500 to-indigo-500'>
      ...
      <section className="mb-32">
        <div className="bg-gradient-to-r from-rose-400 via-fuchsia-500 to-indigo-500">
          ...
          <Image width="600" height="600" loading="lazy" src={profile?.coverPicture?.original?.url || "/Lens.jpeg"} alt="Cover Image" className="w-full h-[500px] hidden lg:flex object-cover absolute border-b-2 border-violet-700" />
